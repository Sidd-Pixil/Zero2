...
from Zerotwo import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Zerotwo.modules." +
                                              module_name)
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I am online now !](https://telegra.ph/file/dc1fc6ddeec115ed296b1.mp4)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
